        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Session["name"] as string))
            {
                ...
                if (menu != null)
                {
                    ...
                    //parentPatientItem.ChildItems.Remove(patientExaminationa);
                    //menu.Items.Remove(mnuItem);
                    //menu.FindItem("patientregistration/examination")).
                    //mnuItem.ChildItems.Remove();
                    //menu.Items.Remove(menu.FindItem("Registration"));
